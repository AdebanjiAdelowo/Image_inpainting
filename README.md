...
|---|---|
| [`Image_Inpainting.ipynb`](Image_Inpainting.ipynb) | Single implementation with full history storage and convergence plots |
| [`Adebanji_Image_Inpainting.ipynb`](Adebanji_Image_Inpainting.ipynb) | Compares two implementations: memory-efficient (scalar variables) and full history storage |
